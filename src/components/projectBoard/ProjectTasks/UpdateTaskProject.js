...
class UpdateTaskProject extends Component {
    constructor() {
        super();
...
export default connect(mapStateToProps, { getProjectTask, updateProjectTask })(UpdateTaskProject);
